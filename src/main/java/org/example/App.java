...
public class App
{
    ...
    {
        Scanner ourquotation = new Scanner(System.in);
        Scanner ourauthor = new Scanner(System.in);


        System.out.println("What is the quote?");
        String theoutputQuote=ourquotation.nextLine();


        System.out.print("Who said it?");
        String theguy =  ourauthor.nextLine();


        System.out.print(theguy + " says, " + "\"" + theoutputQuote + "\"");
    }
}
